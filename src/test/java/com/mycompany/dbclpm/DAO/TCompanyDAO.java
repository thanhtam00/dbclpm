...
public class TCompanyDAO {
    ...
    public void TestCaseGetByCode1() {
        assertTrue(compareCompany(new Company(1,"Samsung","CT01",stringToDate("2019-01-01"),1,3), companyDAO.getByCOde("CT01")));
    }
    ...
    public void TestCaseGetByCode2() {
        assertTrue(compareCompany(new Company(2,"Blameo","CT02",stringToDate("2019-06-01"),1,3), companyDAO.getByCOde("CT02")));
    }
